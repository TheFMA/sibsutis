...
{
    int m = 11;
    // vector<int> input = { 23, 30, 32, 4, 16, 14, 1, 10, 13, 55, 56, 37, 27,
    // 85, 73, 62, 53, 2, 16, 64, 72, 43, 46, 48 };
    vector<int> input = {67, 45, 8, 56, 9, 13, 15, 57, 33, 11, 24, 77};
    // vector<int> input = {1, 3, 4, 5, 6, 7, 8, 10, 13, 14, 9};
    // vector<int> input = {1, 23, 46, 89, 102, 78, 90, 45, 32, 56, 44, 34, 67,
    // 11};
    ...
    printStat(
            m,
            (int)input.size(),
            secondTaskLinear(input, m),
            secondTaskSquare(input, m));
}